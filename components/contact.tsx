...
const Contact = () => {
  return (
    <div className="max-w-screen-md m-auto w-full">
      <h1 className="sr-only">Mohammad Islayh - Contact Me</h1>
      <div className="mb-4 font-medium text-white text-2xl">Contact Me</div>
      <div className="mb-5 flex gap-4 flex-wrap flex-col">
        <a
          href="mailto:moislayh@gmail.com"
          className="flex justify-start items-center gap-2 hover:underline w-fit"
        >
